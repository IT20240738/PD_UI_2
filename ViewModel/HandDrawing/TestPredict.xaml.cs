...
public partial class TestPredict : ContentPage
{
    ...
    private async void UploadImage2_Clicked(object sender, EventArgs e)
    {
    ...
    private async void CloseButton2_Clicked(object sender, EventArgs e)
    {
